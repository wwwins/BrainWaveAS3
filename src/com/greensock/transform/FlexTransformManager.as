 ...
 */
	public class FlexTransformManager extends Canvas {
		...
		public function addSelectionBoxElement(element:DisplayObject, alignment:String="topRight", xOffset:Number=0, yOffset:Number=0):void {
			_manager.addSelectionBoxElement(element, alignment, xOffset, yOffset);
		}
...
//---- XML EXPORTING AND APPLYING ------------------------------------------------------------------------------
		...
		override public function setActualSize(w:Number, h:Number):void {
			if (h != 0 && w != 0 && (_manager.bounds == null || _manager.bounds.width != w || _manager.bounds.height != h)) {
				_manager.bounds = new Rectangle(0, 0, w, h);
			}
