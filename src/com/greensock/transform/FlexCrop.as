 ...
 * When <code>maskEnabled</code> is <code>true</code>, the <code>target</code> will be masked visually. <br /><br />
 * 
 * The FlexCrop object is treated as just another TransformItem in the associated TransformManager so that it is able 
 * to be moved/scaled/rotated/selected. <br /><br />
 * 
 ...
 * </ul>
 * 
 * When <code>cropMode</code> is changed to <code>false</code>, a <code>"exitCropMode"</code> Event is dispatched.<br /><br />
 * 
 * To enter cropMode, simply double-click on the FlexCrop object or manually set <code>cropMode</code> to <code>true</code>.
 ...
 * <code>configureCropMode()</code> method).  
 * 
	...
	public class FlexCrop extends UIComponent {
		...
		public function calibrateDepths(event:Event=null, leaveTarget:Boolean=false):void {
			...
			if (!leaveTarget && thisIndex == 0) {
				...
				Object(this.parent).setChildIndex(_target, thisIndex - 1);
			} else {
