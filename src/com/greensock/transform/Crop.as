 ...
 * 
 * The Crop object is treated as just another TransformItem in the associated TransformManager so that it is able 
 ...
 * 
 * To enter cropMode, simply double-click on the Crop object or manually set <code>cropMode</code> to <code>true</code>.
